            ...
            <div className="container w-4/5 mx-auto">
                <div className="flex justify-between">
                    <ul className="flex flex-row justify-center items-center">
                        <NavLink exact to="/" activeClassName="" className="py-4 text-2xl font-extrabold text-green-500">Users</NavLink>
                    ...
                    <ul className="flex flex-row justify-center items-center">
                        <NavLink exact to="/users/add"><li className="transition-colors duration-500 shadow-inner px-2 py-2 text-white font-extrabold rounded-md bg-green-500 hover:bg-green-600 hover:text-white">Add User</li></NavLink>
                    </ul>
                </div>
            </div>
        </nav>
